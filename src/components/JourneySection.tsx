...
const timelineData = [
  ...
  },
  {
    ...
    description: "Four years of learning, building, researching, and discovering networking • foundation for long-term growth in systems and infrastructure",
    icon: GraduationCap,
    future: true,
  },
  {
    ...
    description: "Nirad Networks, Bengaluru — supporting routing, switching, Linux-based networking, and connectivity operations",
    icon: Briefcase,
    highlight: false,
  },

  {
    ...
    description: "Exploring opportunities that align with networking, systems, and infrastructure growth while continuing to build strong hands-on expertise",
    icon: Zap,
    future: true,
  }
];
